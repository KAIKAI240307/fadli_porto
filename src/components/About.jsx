    ...
    <>
      ...
      >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div className="space-y-6">
                <p className="about-intro text-stone-400 text-xs uppercase tracking-[0.25em] font-medium">
                  About Me
                </p>
                <h2 className="about-intro text-2xl md:text-3xl lg:text-4xl font-display font-bold text-stone-900 leading-relaxed uppercase tracking-tight">
                  In the game since 2021, constantly evolving
                  <span className="text-stone-400">.</span>
                </h2>
                <p className="about-intro text-lg text-stone-600 leading-relaxed">
                  I am a passionate Data Analyst and Machine Learning Engineer
                  with a knack for turning complex data into actionable
                  insights. My approach combines technical expertise with
                  creative problem-solving to build scalable, efficient, and
                  user-centric solutions.
                </p>
                <p className="about-intro text-stone-500 leading-relaxed">
                  Every project starts from the same place:{" "}
        ...
        <div className="certifications-section py-20 lg:py-28 px-6 lg:px-16">
          <div className="max-w-7xl mx-auto">
            <p className="text-stone-400 text-xs uppercase tracking-[0.25em] mb-12 font-medium">
              Certifications
            </p>
            <div className="space-y-0">
              {certifications.map((cert, index) => (
                <div
                  key={cert.id}
                  className="cert-item group border-b border-stone-200 py-5 cursor-pointer hover:bg-stone-100/50 transition-all duration-300 px-4 -mx-4 rounded-lg"
                  onClick={() => setSelectedCert(cert)}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-6">
                      <span className="text-stone-300 text-sm font-mono w-6 font-bold">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <svg
                        className="w-5 h-5 text-stone-300 group-hover:text-stone-900 group-hover:translate-x-1 transition-all"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap gap-3">
              {hardSkills.map((skill) => (
                <span
                  key={skill}
                  className="hard-skill-tag px-5 py-2.5 bg-stone-100 border border-stone-200 rounded-full text-stone-700 text-sm font-medium hover:bg-stone-900 hover:text-white hover:border-stone-900 transition-all duration-300 cursor-default"
                >
                  {skill}
                </span>
              ))}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap gap-3">
              {softSkills.map((skill) => (
                <span
                  key={skill}
                  className="soft-skill-tag px-5 py-2.5 bg-amber-50 border border-amber-200 rounded-full text-amber-800 text-sm font-medium hover:bg-amber-800 hover:text-white hover:border-amber-800 transition-all duration-300 cursor-default"
                >
                  {skill}
                </span>
              ))}
